...
const ZipDotAscent = () => {
    ...
    if (level <= 120) {
        // Tier 1: Easy (Levels 1 - 120) -> 5x5 up to 10x10
        currentDifficulty = "easy";
        tierRelativeLevel = level;
    } else if (level <= 240) {
        // Tier 2: Medium (Levels 121 - 240) -> Resets to 5x5 up to 10x10
        currentDifficulty = "medium";
        tierRelativeLevel = level - 120;
    } else {
        // Tier 3: Hard Endless (Levels 241+) -> Resets to 5x5 and cycles sizes every 120 stages
        currentDifficulty = "hard";
        tierRelativeLevel = ((level - 241) % 120) + 1;
    }
